...
switch (cmd) {
  case "job": {
    ...
    if (!["creature", "prop", "plant", "image"].includes(sub)) die('usage: forge job creature|prop|plant|image "prompt" [--profile P] [--seed N] [--count N] [--height M] [--views front|multi] [--rig] [--batch L]\n       forge job image "prompt" [--kind sprite|texture|tile] [--transparent|--opaque] [--seamless|--no-seamless] [--size N]\n       forge job batch <file.yaml>');
  ...
  default: die("commands: job (creature|prop|plant|image|batch), status, watch, list, get, approve, reject, rerun, batches, health, profiles");
}
